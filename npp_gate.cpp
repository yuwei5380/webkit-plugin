                ...
                NPSavedData* saved)
{
  ...
  CPlugin * pPlugin = new CPlugin(instance);			//instance but no data
  if(pPlugin == NULL)
    return NPERR_OUT_OF_MEMORY_ERROR;
  
  instance->pdata = (void *)pPlugin;					//CPlugin member
  return rv;
}
...
NPError NPP_SetWindow (NPP instance, NPWindow* pNPWindow)//windowsless plugin, not to care about
{
  if(instance == NULL)
    return NPERR_INVALID_INSTANCE_ERROR;
...
NPError	NPP_GetValue(NPP instance, NPPVariable variable, void *value)
{
  ...
  case NPPVpluginNameString:
    *((char **)value) = "NPRuntime test.synjones";
    break;
